...
const UploadProduct = () => {
  ...
  // Sắp xếp danh mục theo tên để dễ tìm kiếm
        ...
        <form className="grid gap-4" onSubmit={handleSubmit}>
          ...
          <div>
            ...
            <div>
              <label
                ...
                className={`flex h-24 items-center justify-center rounded border ${errors.image ? "border-red-500" : "border-slate-200"} bg-blue-50`}
              >
          ...
          <div className="grid gap-1">
            ...
            <input
              ...
              value={data.price}
              onChange={handleChange}
              className={`focus-within:border-primary-200 rounded border ${errors.price ? "border-red-500" : "border-slate-200"} bg-blue-50 p-2 outline-none`}
            />
            {errors.price && (
